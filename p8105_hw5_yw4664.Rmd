...
No, the sample average of μ̂ across tests for which the null was rejected is not equal to the true μ, when μ is small.

This happens because only samples with unusually large μ̂ are likely to be significant when the true effect is small.